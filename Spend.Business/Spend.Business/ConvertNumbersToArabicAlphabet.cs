...
namespace Spend.Business
{
   public  class ConvertNumbersToArabicAlphabet
    {
       public  string NumberAr;
        //public ConvertNumbersToArabicAlphabet(string Number)
        //{
        //    NumberAr = ConvertNumberToAlpha(Number);
        //}
        public ConvertNumbersToArabicAlphabet()
        {

        }
        public  string ConvertNumberToAlpha(string Number)
        {
            if (Number.Contains('.'))
            {
                ...
                else
                {
                    ...
                    {
                        case 1: return convertOneDigits(Number.ToString()) + " ريال " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 2: return convertTwoDigits(Number.ToString()) + " ريال " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 3: return convertThreeDigits(Number.ToString()) + " ريال " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 4: return convertFourDigits(Number.ToString()) + " ريال " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 5: return convertFiveDigits(Number.ToString()) + " ريال " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 6: return convertSixDigits(Number.ToString()) + " ريال " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 7: return convertSixDigits(Number.ToString()) + " ريال " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        case 1: return convertOneDigits(Number.ToString()) + " ريال ";
                        case 2: return convertTwoDigits(Number.ToString()) + " ريال ";
                        case 3: return convertThreeDigits(Number.ToString()) + " ريال ";
                        case 4: return convertFourDigits(Number.ToString()) + " ريال ";
                        case 5: return convertFiveDigits(Number.ToString()) + " ريال ";
                        case 6: return convertSixDigits(Number.ToString()) + " ريال ";
                        case 7: return convertSevenDigits(Number.ToString()) + " ريال ";
                        default: return "";
                    }
        ...
        {
            switch (int.Parse(SevenDigits.ToCharArray()[0].ToString()))
            {
                case 1:
                    {
                        if (int.Parse(SevenDigits.ToCharArray()[1].ToString()) == 0)
                        {
                            if (int.Parse(SevenDigits.ToCharArray()[2].ToString()) == 0)
                            {
                                if (int.Parse(SevenDigits.ToCharArray()[3].ToString()) == 0)
                                    return "مليون";
                                else
                                {
                                    return "مليون" + " و " + convertOneDigits(SevenDigits.ToCharArray()[3].ToString());
                                }
                            }
                            return "مليون" + " و " + convertTwoDigits(SevenDigits.Substring(2, 2));
                        }
                        else
                        {
                            return "مليون" + " و " + convertSixDigits(SevenDigits.Substring(1, 6));
                        }
                    }
                case 2:
                    {
                        if (int.Parse(SevenDigits.ToCharArray()[1].ToString()) == 0)
                        {
                            if (int.Parse(SevenDigits.ToCharArray()[2].ToString()) == 0)
                            {
                                ...
                                {
                                    return "مليونين" + " و " + convertOneDigits(SevenDigits.ToCharArray()[3].ToString());
                                }
                            }
                            return "مليونين" + " و " + convertTwoDigits(SevenDigits.Substring(2, 2));
                        }
                        else
                        {
                            return "مليونين" + " و " + convertSixDigits(SevenDigits.Substring(1, 6));
                        }
                    }
                case 3:
                    {
                        if (int.Parse(SevenDigits.ToCharArray()[1].ToString()) == 0)
                        {
                            ...
                            {
                                if (int.Parse(SevenDigits.ToCharArray()[3].ToString()) == 0)
                                    return convertOneDigits(SevenDigits.ToCharArray()[0].ToString()) + " ألاف";
                                else
                                {
                                    return convertOneDigits(SevenDigits.ToCharArray()[0].ToString()) + " ألاف" + " و " + convertOneDigits(SevenDigits.ToCharArray()[3].ToString());
                                }
                            }
                            return convertOneDigits(SevenDigits.ToCharArray()[0].ToString()) + " ألاف" + " و " + convertTwoDigits(SevenDigits.Substring(2, 2));
                        }
                        else
                        {
                            return convertOneDigits(SevenDigits.ToCharArray()[0].ToString()) + " ألاف" + " و " + convertSixDigits(SevenDigits.Substring(1, 6));
                        }
                    }
                case 4:
                    {
